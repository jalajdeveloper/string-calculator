...
describe('String Calculator', () => {
    ...
    test('throws error for negative numbers', () => {
        ...
        // Edge case with no negative numbers
    ...
    test('handles special characters in delimiters', () => {
        expect(add("//[***]\n1***2***3")).toBe(6);
        expect(add("//[$$]\n1$$2$$3")).toBe(6);
    });

    test('handles empty strings in input between delimiters', () => {
        expect(add("//;\n1;;2")).toBe(3); // Should handle empty strings between delimiters
    });
});
